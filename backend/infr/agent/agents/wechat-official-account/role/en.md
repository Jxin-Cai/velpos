...
- Unless the user **explicitly names** a specific sub-skill or asks to "only do X", always route through the `/wechat-official-account:woa` workbench entry for task assembly first.
