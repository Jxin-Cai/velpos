...
class ScheduledTaskModel(Base):
    ...
    execution_mode: Mapped[str] = mapped_column(String(24), nullable=False, default="new_session", server_default="new_session")
    prompt_mode: Mapped[str] = mapped_column(String(16), nullable=False, default="prompt", server_default="prompt")
    skill_name: Mapped[str] = mapped_column(String(255), nullable=False, default="", server_default="")
