...
const {
  handleRemoteUnbind: applyImUnbound,
  handleRemoteDeliveryUpdate: applyImDeliveryUpdate,
} = useImBinding()
...
const _wsEventHandlers = {
  ...
  im_delivery_update(sessionId, _data, { isCurrent }) {
    if (isCurrent) applyImDeliveryUpdate(sessionId)
  },
